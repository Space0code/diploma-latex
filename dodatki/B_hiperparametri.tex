...
Nastavitve grafovske konstrukcije smo izbrali po majhnem predhodnem mrežnem iskanju na 3-razredni valenci, glede na izvorne razrede definirane v~\ref{tab:label-mapping}.
Iskanje je spreminjalo $k_t \in \{1,2,3\}$, $k_s \in \{1,2,3\}$ in $k_f \in \{1,2,3,5\}$ pri dveh grafovskih plasteh in skritih predstavitvah velikosti 64.
