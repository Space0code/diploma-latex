...
\newcommand{\LOSO}{LOSO}
\newcommand{\LORO}{LORO}
\DeclareRobustCommand{\ModelName}[1]{\texorpdfstring{\texttt{#1}}{#1}}
...
\begingroup
\catcode`\_=13
\gdef\ENDNOTEActivateUnderscore{%
    \catcode`\_=13
    \def_{\ifmmode\sb\else\textunderscore\fi}%
}
\endgroup
\def\END_NOTE{%
    \begingroup
    \ENDNOTEActivateUnderscore
    \@ifstar{\ENDNOTEBlock}{\ENDNOTEInline}%
}
\makeatother

\newcommand{\ENDNOTEInline}[1]{%
    \footnotesize\itshape\color{orange!70!black}%
    [#1]%
    \endgroup
}

\newcommand{\ENDNOTEBlock}[1]{%
    \par\noindent
    \begingroup
    \footnotesize\itshape\color{black}%
...
% Semantične barve za signale sledilnika pogleda v tabelah in besedilu.
