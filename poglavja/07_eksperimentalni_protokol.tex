...
primerjavi.
Glavna evalvacijska naloga je binarna klasifikacija neprijetne proti prijetni valenci.
...
Podatkovna zbirka \MAHNOB{} v repozitorij ni vključena, ker ni del tega dela in je ne smemo distribuirati.
...
Ciljna oznaka je binarni razred valence, pri kateri model ločuje med neprijetno in prijetno valenco.
...
% pusti napisano v zgodnejših fazah. ne piši, da smo točno ta LOO izvedli kasneje.
V zgodnejših fazah smo za množico \emph{pogled in zenici} izvedli tudi LOO po subjektih.
...
Primerjava obeh validacijskih protokolov za valenco in množico \emph{pogled in zenici} je podana v dodatku~\ref{app:primerjava-loo-po-subjektih}.
