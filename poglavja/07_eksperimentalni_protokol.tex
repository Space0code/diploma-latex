...
V primerjavi smo uporabili vse modeli iz tabele~\ref{tab:pregled-primerjanih-modelov}: izhodiščna klasifikatorja, klasični modeli nad agregiranimi značilkami, zamrznjeni prednaučeni predstavitveni modeli in grafovski modeli.
...
Zato ga uporabimo kot podporno preverjanje na podmnožici podatkovne zbirke, glavno primerjavo pa izvedemo s 7-kratnim protokolom.
...
Krivulje učne in validacijske izgube poročamo med rezultati v poglavju~\ref{sec:rezultati}, diagnostiko naučenih predstavitev in napovedi pa v dodatku~\ref{app:diagnostika-prekomerno-glajenje}.
