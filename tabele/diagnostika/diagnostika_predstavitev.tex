...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.13\textwidth} >{\raggedright\arraybackslash}p{0.16\textwidth} *{6}{>{\centering\arraybackslash}X}@{}}
        \toprule
        \textbf{Množica signalov} & \textbf{Najboljša GNN} & \makecell{\textbf{Makro}\\\textbf{F1}} & \makecell{\textbf{Urav.}\\\textbf{točnost}} & \makecell{\textbf{Razpon}\\\textbf{logitov}} & \makecell{\textbf{Entro-}\\\textbf{pija}} & \makecell{\textbf{Varianca}\\\textbf{predst.}} & \makecell{\textbf{Kos.}\\\textbf{pod.}} \\
        \midrule
