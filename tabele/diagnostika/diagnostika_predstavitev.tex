...
\begin{table}[H]
    \centering
    \caption{Diagnostika naučenih predstavitev in izhodov najboljšega grafovskega modela po množicah signalov.}
    ...
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.13\textwidth} >{\raggedright\arraybackslash}p{0.16\textwidth} *{6}{>{\centering\arraybackslash}X}@{}}
        \toprule
        Množica signalov & Najboljši GNN & \makecell{Makro\\F1} & \makecell{Urav.\\točnost} & \makecell{Razpon\\logitov} & \makecell{Entro-\\pija} & \makecell{Varianca\\predst.} & \makecell{Kos.\\pod.} \\
        \midrule
